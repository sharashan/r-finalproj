...
-   $H_A = \mu_{EU} - \mu_{non-EU} = 0$

-   Fail to reject the null hypothesis (p-value = 0.196)

-   Used two-sided hypothesis test to determine whether or not the difference in true population means of duels for European leagues and non-European leagues is significant

-    $H_0 = \mu_{EU} - \mu_{non-EU} = 0$

-    $H_A = \mu_{EU} - \mu_{non-EU} \not= 0$

-   Reject the null hypothesis (p-value = 0)
