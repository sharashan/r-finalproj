...
## Inference/modeling/other analysis Pt. 1
...
## Inference/modeling/other analysis Pt. 2
...
-   Alternate hypothesis: The true population mean of goals per minute for European and non-European players are different. $H_A = \mu_{EU} - \mu_{non-EU} = 0$
