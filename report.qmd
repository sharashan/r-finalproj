...
-   The dataset was created by a team of individuals who are intrested in football and application of the recorded statistics.

• **Who funded the creation of the dataset? If there is an associated grant, please provide the name of the grantor and the grant name and number.**

-   This dataset is funded through a membership program that allows users of the data to access additional features within the dataset. While people are able to use the data without a membership, certain advanced tasks may require these additional features.
...
-   The people involved are football players, who are aware of data collection, as this occurs during and after all of their games, because sports data is typically used to make general comparison (past/future versions of themselves, comparing their team to another, or between leagues, sports reporting (to football fans), or MVP decisions.

**Is any information missing from individual instances?**

-   In the dataset of soccer player statistics, some instances may have missing information for certain attributes. However, these occurrences of missing data are infrequent. The reason behind the missing information is that the data is compiled from thousands of games across multiple leagues worldwide. Each league or team may prioritize and record specific statistics that they find important, resulting in variations in the recorded statistics across different leagues.

**Are relationships between individual instances made explicit (e.g., users\' movie ratings, social network links)? If so, please describe how these relationships are made explicit.**

-   The relationships between the individual instances (players) are made explicit through the tabular structure, where each row corresponds to a specific player and their associated statistics.

**Are there any errors, sources of noise, or redundancies in the dataset? If so, please provide a description.**

-   As this is game data, it was likely influenced by referee rulings, as some scores may not have counted in the final game statistics.
...
-   The data used in our analysis was collected throughout the respective football seasons of each league in the year 2021. Although the start date and duration of each league's season may have varied slightly, all instances were associated with data from the defined 2021 football season of their respective leagues.

**Did you collect the data from the individuals in question directly, or obtain it via third parties or other sources (e.g., websites)?**

-   The data we utilized was not directly collected from individual soccer players. Instead, it was initially recorded by scorekeepers during each game and subsequently compiled into a comprehensive dataset by the API Football team.
...
*Identifying Important Predictors:* Then, we fit a multiple linear regression line that predicted total bookings based on those variables to determine if any were actually statistically significant, and worth investigating through a hypothesis test in our "Evaluation of Singificance" section:
...
**The following hypothesis test is to determine whether or not the difference in true population means of highly rated players (players with ratings greater than or equal to the mean player rating) and non-highly rated players (players with ratings less than mean player rating) is significant:**
...
**The following hypothesis test is to determine whether or not the difference in true population means of duels for European leagues and non-European leagues is significant:**
...
**The following hypothesis test is to determine whether or not the difference in true population means of averge goals per minute for European leagues and non-European leagues is significant:**

-   Null hypothesis: The true population mean of goals per minute for European and non-European players are not different. $H_0 = \mu_{EU} - \mu_{non-EU} = 0$

-   Alt hypothesis: The true population mean of goals per minute for European and non-European players are different. $H_A = \mu_{EU} - \mu_{non-EU} = 0$
...
Due to the nature of our dataset one coverage bias may be present in our analysis. Since the data is primarily focused on scoring and other offensive statistics, using these attributes alone may not completely represent a players performance and overall impact to their team. In addition, various contextual factors might create additional bias within our data and analysis. These factors include strength of opponent, tactics used by teams and players, and the unpredictable gameday conditions which all play a large role in how players perform and the statistcs they produce.
