...
-   The relationships between the individual instances (players) are made explicit through the tabular structure, where each row corresponds to a specific player and each colum represents their associated statistics.
...
**Has the dataset been used for any tasks already? If so, please provide a description. Is there a repository that links to any or all papers or systems that use the dataset? If so, please provide a link or other access point.**
