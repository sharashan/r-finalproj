...
-   Null Hypothesis: The true population mean of bookings for highly rated players and non-highly rated players are not different, on average. $$ \mu_{high} - \mu_{non-high} = 0 $$
...
NEW P VALUE IS 0.992 WHICH MEANS WE FAIL TO REJECT THE NULL HYPOTHESIS. The data does not provide convincing evidence that on average, the difference in true population mean of bookings for highly rated players and non-highly rated players are different

FROM TWO-SIDED TEST

\*\*delete after double checking data because that was a massive flip\*\*
...
-   Null hypothesis: The true population mean of goals per minute for European and non-European players are not different, on average. $$ \mu_{EU gpm} - \mu_{non-EU gpm} = 0 $$
