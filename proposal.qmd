...
-   Identify the types of variables in your research question. Categorical? Quantitative?
    ...
    -   Other Quantitative used variables are listed below, and they represent various expenditures per capita in USD.
        -   che_pc_usd (current health expenditure)

        -   gghed_pc_usd (domestic general government health expenditure)

        -   pvtd_pc_usd (domestic private health expenditure)

        -   oop_pc_usd (out of pocket expenditure)
...
skim(health, "country", "region", "income", "che_pc_usd", "gghed_pc_usd", "pvtd_pc_usd", "oop_pc_usd")
```
